...
public class Lesson03HomeWork {
    public static void main(String[] args) {
        ...
        int random =(int) (Math.random() * 491 + 10);
      ...
      /**  Задача #2 на if else
        ...
        int monthNumber = 2;
        int year = 1812;
        int numberOfDayInYear = ((year % 4 == 0 && year % 100 != 0) || (year % 400 == 0)) ? 366 : 365;
        ...
        double resultSumWithoutDiscount = 157.5;
        double resultSum = switch (couponNumber) {
            case 1111, 4444, 9999 -> 0.9 * resultSumWithoutDiscount;
            case 3333, 7777 -> 0.8 * resultSumWithoutDiscount;
            case 5555 -> 0.7 * resultSumWithoutDiscount;
            default -> resultSumWithoutDiscount;
        };
